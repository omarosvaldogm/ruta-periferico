      ...
      <div className="max-w-7xl mx-auto px-4 pb-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <button 
              className={`flex items-center px-3 py-2 text-sm font-medium ${activeTab === 'delivery' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
        ...
        {/* Segunda fila - Barra de búsqueda (solo aparece en la pestaña de viaje) */}
        {activeTab === 'ride' && (
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4">
            <div className="pt-2 pb-3 space-y-1">
              ...
              <button 
                className={`flex items-center w-full px-3 py-2 text-base font-medium ${activeTab === 'delivery' ? 'bg-indigo-50 text-indigo-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
                onClick={() => {
